...
// Copyright (c) 2017-2019 The Hash developers
...
#if defined(NDEBUG)
#error "Hash cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uhash) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // HASH: We use certain sporks during IBD, so check to see if they are
